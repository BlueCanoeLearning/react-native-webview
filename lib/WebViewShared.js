...
var defaultRenderLoading = function () { return (<View style={styles.loadingView}>
    <ActivityIndicator />
  </View>); };
var defaultRenderError = function (errorDomain, errorCode, errorDesc) { return (<View style={styles.errorContainer}>
