...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.getCommands = function () { return getViewManagerConfig('RNCWKWebView').Commands; };
        /**
        ...
        _this.setIgnoreSilentSwitch = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().ignoreSilentSwitch, [data]);
        };
        /**
    ...
    WebView.prototype.render = function () {
        var _a = this.props, decelerationRateProp = _a.decelerationRate, _b = _a.nativeConfig, nativeConfig = _b === void 0 ? {} : _b, onMessage = _a.onMessage, onShouldStartLoadWithRequestProp = _a.onShouldStartLoadWithRequest, originWhitelist = _a.originWhitelist, renderError = _a.renderError, renderLoading = _a.renderLoading, style = _a.style, otherProps = __rest(_a, ["decelerationRate", "nativeConfig", "onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "style"]);
        var otherView = null;
        ...
        var webView = (<NativeWebView key="webViewKey" {...otherProps} decelerationRate={decelerationRate} messagingEnabled={typeof onMessage === 'function'} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onMessage={this.onMessage} onScroll={this.props.onScroll} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} ref={this.webViewRef} 
    ...
    WebView.isFileUploadSupported = function () { return __awaiter(_this, void 0, void 0, function () {
